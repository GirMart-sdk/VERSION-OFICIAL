...
if (!db.user) {
  console.error("❌ [Seed] ERROR: El modelo 'user' no está definido en el cliente Prisma.");
  console.error("   Esto ocurre porque la tabla de usuarios no existe en la base de datos 'winn_11'.");
